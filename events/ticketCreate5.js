...
if(!interaction.isButton() && !interaction.isSelectMenu()) return;
      ...
      if(interaction.customId == `create_ticket${s}`) {
        ...
        .setFooter(`Ticketing by cyberneticsdev.tk`, interaction.guild.iconURL())
        ...
        .addComponents([
         ...
         await interaction.reply({ content: `<a:loading:975710177032544316> **Creating your ticket (This could take a few seconds)...**`, ephemeral: true })
        ...
        .setAuthor(`Ticket for: ${interaction.user.tag}`, interaction.user.displayAvatarURL(), `https://dsc.gg/cyberdev`)
  ...
  .setRequired(false) // If it's required or not
    ...
    showModal(modal, {
      ...
      interaction: interaction // Show the modal with interaction data.
        ...
        const embed2 = new MessageEmbed()
        .setColor(client.config.color.main)
        .setAuthor(`${interaction.user.tag} ⚡ Staff Member`, interaction.user.displayAvatarURL(), `https://dsc.gg/cyberdev`)
